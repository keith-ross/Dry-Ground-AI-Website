        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight">
              <span className="block">Solving Business</span>
              <span className="block mt-2 text-brand-primary">
                Challenges with AI
              </span>
            </h1>
            <p className="mt-6 text-xl text-gray-300 max-w-3xl">
              Dry Ground AI delivers cutting-edge artificial intelligence solutions that drive real business outcomes. We turn complex data into actionable insights.
            </p>
